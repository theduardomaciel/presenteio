	...
	return (
		<div className={styles.container}>
			<div className={styles.content}>
				...
				<p>
					Nem todos os participantes já foram confirmados, por isso, o
					sorteio ainda não foi realizado. <br /> <br />
					<strong>
						Não se preocupe pois você receberá um e-mail assim que o
