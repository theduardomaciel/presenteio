    ...
    return (
        <Modal
            ...
            returnButton={{
                enabled: true,
                text: "Voltar",
                icon: <ArrowRightIcon width={18} height={18} fill={`var(--primary-02)`} style={{ transform: 'rotate(180deg)' }} />
            }}
        >
            <div className={inputStyles.input} style={{ gap: "1rem", height: "fit-content" }}>
                <p onClick={onLinkClick} ref={linkTextRef} className='link' style={{ cursor: "pointer", maxWidth: "90%" }}>{link}</p>
