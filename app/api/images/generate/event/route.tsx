...
export async function GET(request: NextRequest) {
	...
	try {
		...
		const name = searchParams.get("name") || "Evento";
		const type = searchParams.get("type") || ("AMIGOSECRETO" as EventType);
